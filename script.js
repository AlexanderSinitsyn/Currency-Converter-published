...
/* harmony import */ var _modules_dateInput__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/dateInput */ "./src/js/modules/dateInput.js");
/* harmony import */ var _modules_currencyWidget__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/currencyWidget */ "./src/js/modules/currencyWidget.js");
/* harmony import */ var _modules_converter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/converter */ "./src/js/modules/converter.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_dateInput__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_modules_currencyWidget__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_converter__WEBPACK_IMPORTED_MODULE_2__["default"])();
});
...
var converter = function converter() {
  var inputFrom = document.querySelector("#input_from");
  var inputTo = document.querySelector("#input_to");
  var currencyFrom = document.querySelector("#select_curr_from");
  var currencyTo = document.querySelector("#select_curr_to");
  var date = document.querySelector("#date");
  var rateType = document.querySelector("#select_type");
  var switcher = document.querySelector(".switcher_img");
  var selectedDate;

  var dateTransform = function dateTransform() {
    selectedDate = date.value.split("-").join("");
  };

  var switchCurrencies = function switchCurrencies() {
    var right = currencyTo.value;
    currencyTo.value = currencyFrom.value;
    currencyFrom.value = right;
  };

  var getDataNbu = function getDataNbu(currencyName, rateDate) {
    var response, data, result;
    return regeneratorRuntime.async(function getDataNbu$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap(fetch("https://bank.gov.ua/NBUStatService/v1/statdirectory/exchange?valcode=".concat(currencyName, "&date=").concat(rateDate, "&json")));
  ...
  var getDataPrvt = function getDataPrvt() {
    var response, data, result;
    return regeneratorRuntime.async(function getDataPrvt$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return regeneratorRuntime.awrap(fetch("https://api.privatbank.ua/p24api/pubinfo?json&exchange&coursid=5"));
  ...
  var bindNbuData = function bindNbuData(selectedDate) {
    var resultRateTo, resultRateFrom, _resultRateFrom, _resultRateTo;

    return regeneratorRuntime.async(function bindNbuData$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return regeneratorRuntime.awrap(getDataNbu(currencyTo.value, selectedDate));

          case 3:
            resultRateTo = _context3.sent;
          ...
          case 7:
            ...
            _context3.next = 10;
            return regeneratorRuntime.awrap(getDataNbu(currencyFrom.value, selectedDate));

          case 10:
            resultRateFrom = _context3.sent;
          ...
          case 20:
            _resultRateFrom = _context3.sent;
            _context3.next = 23;
            return regeneratorRuntime.awrap(getDataNbu(currencyTo.value, selectedDate));

          case 23:
            _resultRateTo = _context3.sent;
            inputTo.value = (_resultRateFrom[0]["rate"] / _resultRateTo[0]["rate"] * inputFrom.value).toFixed(2);
  ...
  var bindPrvtData = function bindPrvtData() {
    var resultRate, _resultRate, _resultRate2, rateFrom, rateTo;

    return regeneratorRuntime.async(function bindPrvtData$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return regeneratorRuntime.awrap(getDataPrvt());

          case 3:
            resultRate = _context4.sent;
            resultRate.forEach(function (item) {
          ...
          case 10:
            _resultRate = _context4.sent;

            _resultRate.forEach(function (item) {
          ...
          case 18:
            if (!(currencyFrom.value === "GBP" || currencyTo.value === "GBP")) {
              _context4.next = 22;
              break;
            }
          ...
          case 24:
            _resultRate2 = _context4.sent;

            _resultRate2.forEach(function (item) {
              if (item["ccy"] === currencyFrom.value) {
                rateFrom = item["buy"];
  ...
  var calcActivation = function calcActivation() {
...
/***/ "./src/js/modules/currencyWidget.js":
/*!******************************************!*\
  !*** ./src/js/modules/currencyWidget.js ***!
  \******************************************/
/*! exports provided: default */
...
var currencyWidget = function currencyWidget() {
  var response, data, result, usdRates, eurRates, gbpRates, getZero, previousDay, prevDate, prevDayResponse, prevDaydata, prevdayResult, prevUsdRate, prevEurRate, prevGbpRate, currencyChange;
  return regeneratorRuntime.async(function currencyWidget$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(fetch("https://bank.gov.ua/NBUStatService/v1/statdirectory/exchange?json"));
        ...
        case 8:
          result = _context.sent;
          usdRates = document.querySelector('[data-value="USD"]');
          eurRates = document.querySelector('[data-value="EUR"]');
          gbpRates = document.querySelector('[data-value="GBP"]');
          ...
          previousDay = function previousDay() {
            var currentDateArr = result[0]["exchangedate"].split(".");
          ...
          prevDate = previousDay().reverse().join("");
          _context.next = 18;
          return regeneratorRuntime.awrap(fetch("https://bank.gov.ua/NBUStatService/v1/statdirectory/exchange?date=".concat(prevDate, "&json")));

        case 18:
          prevDayResponse = _context.sent;
          _context.next = 21;
          return regeneratorRuntime.awrap(prevDayResponse.json());

        case 21:
          prevDaydata = _context.sent;
          _context.next = 24;
          return regeneratorRuntime.awrap(prevDaydata);

        case 24:
          prevdayResult = _context.sent;
          prevdayResult.forEach(function (item) {
            switch (item['cc']) {
              case "USD":
...
/* harmony default export */ __webpack_exports__["default"] = (currencyWidget);

/***/ }),

/***/ "./src/js/modules/dateInput.js":
/*!*************************************!*\
  !*** ./src/js/modules/dateInput.js ***!
  \*************************************/
/*! exports provided: default */
